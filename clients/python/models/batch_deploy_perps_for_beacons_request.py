...
T = TypeVar("T", bound="BatchDeployPerpsForBeaconsRequest")



@_attrs_define
class BatchDeployPerpsForBeaconsRequest:
    """ Batch deploy perpetual contracts for multiple beacons

        Attributes:
            beacon_addresses (list[str]): List of beacon addresses to deploy perps for
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_deploy_perps_for_beacons_request = cls(
            beacon_addresses=beacon_addresses,
            fees_module=fees_module,
            margin_ratios_module=margin_ratios_module,
            lockup_period_module=lockup_period_module,
        ...
        batch_deploy_perps_for_beacons_request.additional_properties = d
        return batch_deploy_perps_for_beacons_request
