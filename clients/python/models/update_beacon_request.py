...
T = TypeVar("T", bound="UpdateBeaconRequest")



@_attrs_define
class UpdateBeaconRequest:
    """ Update an existing beacon with new data using a zero-knowledge proof
        ...
        Attributes:
            ...
            public_signals (str): Public signals from the proof as hex string (with 0x prefix), contains the new data value
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_beacon_request.additional_properties = d
        return update_beacon_request
